...
> The `%2F` in the request URL is required to prevent the owner and repository name in the repository slug from being interpreted as different URL segments.
